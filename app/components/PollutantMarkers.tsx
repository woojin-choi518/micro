  ...
  useLayoutEffect(() => {
    ...
    viewer.entities.add({
      ...
      description: new ConstantProperty(`
        <div style="
          background-color: rgba(32, 34, 37, 0.10);
          padding: 12px;
          color: #ffffff;
          font-size: 14px;
          line-height: 1.4;
        ...
        ">
          ...
          <h4 style="margin-bottom:4px; color:#fff380;">주요 미생물 그룹</h4>
          <p style="margin:0;">
    ...
    viewer.entities.add({
      ...
      description: new ConstantProperty(`
        <div style="
          ...
          box-sizing: border-box;
        ">
          <h3 style="margin-top:0; color:#fff380;">근해(Near‐shore) 지역</h3>
          ...
          <h4 style="margin-bottom:4px; color:#fff380;">연구 방법</h4>
          <p style="margin:0 0 8px 0;">
    ...
    viewer.entities.add({
      ...
      description: new ConstantProperty(`
        <div style="
          ...
          box-sizing: border-box;
        ">
          <h3 style="margin-top:0; color:#fff380;">누나부트(Nunavut) 지역</h3>
          ...
          <h4 style="margin-bottom:4px; color:#fff380;">연구 결과 (15일)</h4>
          <ul style="margin:0; padding-left:1em;">
    ...
    viewer.entities.add({
      ...
      description: new ConstantProperty(`
        <div style="
          ...
          box-sizing: border-box;
        ">
          <h3 style="margin-top:0; color:#fff380;">노스웨스트 패시지(Northwest Passage)</h3>
    ...
    viewer.entities.add({
      ...
      description: new ConstantProperty(`
        <div style="
          ...
          box-sizing: border-box;
        ">
          <h3 style="margin-top:0; color:#fff380;">리빙스턴 섬, 바이러스 반도 (Byers Peninsula, Livingston Island)</h3>
          ...
          <h4 style="margin-bottom:4px; color:#fff380;">연구 결과</h4>
          <ul style="margin:0; padding-left:1em;">
    ...
    viewer.entities.add({
      ...
      description: new ConstantProperty(`
        <div style="
          ...
          box-sizing: border-box;
        ">
          <h3 style="margin-top:0; color:#fff380;">아서 하버 (Arthur Harbor), 팔머 스테이션 인근</h3>
    ...
    viewer.entities.add({
      ...
      description: new ConstantProperty(`
        <div style="
          ...
          box-sizing: border-box;
        ">
          <h3 style="margin-top:0; color:#fff380;">라르스만 힐스 (Larsemann Hills), 동남극</h3>

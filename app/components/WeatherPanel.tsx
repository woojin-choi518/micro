...
const WeatherComponent = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-teal-900/20 to-blue-900/20 p-4 rounded-2xl shadow-lg">
      <h3 className="text-white text-sm font-bold mb-3">현재 날씨 (업데이트: {lastUpdated})</h3>
